...
const signUp = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield auth_service_1.AuthService.createSignUp(req, res);
...
const forgotPassword = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield auth_service_1.AuthService.forgotPasswordIntoDB(email);
    (0, sendResonse_1.default)(res, {
        success: true,
        statusCode: 200,
...
const resetPassword = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    // return
    const result = yield auth_service_1.AuthService.resetPasswordIntoDB(token, password);
    (0, sendResonse_1.default)(res, {
        success: true,
        statusCode: 200,
...
const updateUserFromDB = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield auth_service_1.AuthService.updateUserIntoDB(userEmail, req.body, req, res);
    (0, sendResonse_1.default)(res, {
        success: true,
        statusCode: 200,
